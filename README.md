<div>
  ...
  [![Typing SVG](https://readme-typing-svg.demolab.com?font=Rubik+Doodle+Shadow&pause=1000&color=99E4F7&center=true&vCenter=true&random=false&width=435&lines=What+is+up;I+am+a+fresh+Computer+Science+gradute)](https://git.io/typing-svg)
   </div>
</div> 
...
🎓 I'm a Fresh Computer Science graduate, currently on a journey of learning and mastering a diverse set of technologies:

- 🚀 Exploring the world of mobile app development with **Flutter**, **Dart**, and **Swift**.
...
[![My Skills](https://skillicons.dev/icons?i=androidstudio,bash,c,eclipse,figma,github,java,js,matlab,mysql,py,pytorch,tensorflow,vscode,linux,docker,kubernetes,anaconda,nginx,powershell,swift,flutter,unity,cs,cloudflare,css,dart,firebase,html,js,php,regex,vscode,visualstudio)](https://skillicons.dev)
