...
[![My Skills](https://skillicons.dev/icons?i=androidstudio,bash,c,eclipse,figma,github,java,js,matlab,mysql,py,pytorch,tensorflow,vscode,linux,docker,kubernetes,anaconda,nginx,powershell,swift,flutter,unity,anaconda,androidstudio,cs,cloudflare,css,dart,firebase,html,js,php,powershell,regex,vscode,visualstudio)](https://skillicons.dev)
