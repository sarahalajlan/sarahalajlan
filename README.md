...
[![My Skills](https://skillicons.dev/icons?i=androidstudio,bash,c,eclipse,figma,github,java,js,matlab,mysql,py,pytorch,tensorflow,vscode,linux,docker,Kubernetes)](https://skillicons.dev)
